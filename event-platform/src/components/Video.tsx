                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img 
                                ...
                                src="https://github.com/wevdiaz.png" 
                                alt="foto pessoal do perfil do github" 
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Weverson Diaz</strong>
                                <span className="text-gray-200 text-sm block">Desenvolvedor Frontend</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                        ...
                        <div className="py-6 leading-relaxed">
                            ...
                            <p className="text-sm text-gray-200 mt-2"> 
                                Acesse o material complementar para acelerar o seu desenvolvimento e aumentar o aprendizado
                            </p>
                        </div>
